    ...
    popup: {
      ...
      footer: {
        ...
        button: {
          ...
          today: "bg-crimson text-white hover:bg-crimson-dark",
          clear:
      ...
      days: {
        ...
        items: {
          ...
          item: {
            ...
            selected: "bg-crimson text-white hover:bg-crimson-dark",
...
export default function CustomDatepicker({setSelectedDate} : {setSelectedDate: (date: string) => void}) {

  ...
  if (user.data.user) {
    ...
    return (
      <main className="animate-in px-3">
        ...
        {ridesToday?.length! > 0 || (eligibleRides && eligibleRides.length > 0) && <h2 className="text-2xl font-light text-center mt-3">
        ...
        {eligibleRides &&
          ...
          ridesToday.length == 0 && (
            <h3 className="text-xl font-bold mt-6 text-center">
              There are no upcoming rides available. Would you like to schedule a new one?
            </h3>
          )}
